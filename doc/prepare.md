...
- [Open mongo-agent the first time](#open-mongo-agent-the-first-time)
  ...
  - [Open mongo-agent with Vscode](#open-mongo-agent-with-vscode)
...
## Open mongo-agent the first time
...
```bash
git clone https://github.com/rljson/mongo-agent.git
```
