...
describe('ShellComponent', () => {
  ...
  it('should have network navigation item', () => {
    const networkItem = component.navItems.find(item => item.path === '/network');
  ...
  it('should have conflicts navigation item', () => {
    const conflictsItem = component.navItems.find(item => item.path === '/conflicts');
  ...
  it('should have settings navigation item', () => {
    const settingsItem = component.navItems.find(item => item.path === '/settings');
